...
public class RunningProjectsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_running_projects);
        context = RunningProjectsActivity.this;
        initView();
        Utils.setUpToolbar(context, "Running Projects");
    }
